function U=tfuni2(z);
% U=tfuni2(z);
% version: Mariem Kallel and Pierre Comon, revised June 22, 2005
% z: a noisy data matrix of size 2xN, possibly complex.
% Search for a unitary direct transform, U,
% for separating 2 sources in the presence of unknown noise.
% Contrast used = sum of marginal cumulants (without squares);
% Needs independent sources to have cumulants of the same sign, sw=-1.
% U: plane complex rotation separating the 2 sources
% The estimated sources can be obtained merely by s=U*z.
% Observation z and matrix U can be either real or complex
% Compared to tfuni1 developped in 1996: 
%   this function works better, indifferently in real or complex cases
% References:
%   Comon-Moreau, ICASSP97, Munich, April 20-24 1997.
%   Comon ICISP, Agadir, Morocco, May 3-5, 2001.
