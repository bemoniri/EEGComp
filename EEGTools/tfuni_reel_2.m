...
% e: a 2xT real noisy data matrix, zero-mean.
% A=tfuni4R(e) is a real plane rotation such that S=A*e has
% approximately independent components.
% Comon, version 12 feb 1992
% English comments added in 1994
% Number of output arguments reduced on January 6, 1999
% (this is the only difference with tfuni4.m)
T=length(e);
%%%%% moments d'ordre 2
